     ...
     if  ($numFilas!=0)
     {
          if ($vector=pg_fetch_array($result1))
		{
     		...
     		$id_conductor=$vector["1"];
               ...
               $contenido=$vector["5"];
?>
               <form action="PHP/modifica_comentarioConductor.php" method="POST">
               <table id="consulta">
                    <tr>
                         <td colspan="2" >
                              <h2>
                    ...
                    <tr>
                         ...
                         <td> <input type="text" name="id_comentario_conductor" readonly value="<?PHP echo $id_comentario_conductor; ?>"></td>
                    </tr>
                    <tr>
                         <td>&nbsp;ID CONDUCTOR&nbsp;</td>
