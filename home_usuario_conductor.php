...
<html lang="es">
<head>
	<title>Uniway-usuario-conductor</title>
...
<nav>
	<ul>
		<li>
			...
			<ul class="sinmenu" >
				<li>
	                    <a href="home_usuario_conductor.php">Inicio </a>
				</li>
				<li>
					<a href="contacto.html">Contacto</a>
				</li>
				<li>
					<a href="home_usuario_conductor.php#misionyvision">Quienes somos</a>
				</li>
				<li>
...
<!--LOGOOO-->
<div id="logo">
	<a href="home_usuario_conductor.php">
...
<header>
	...
	<p>
		Crea rutas y compartelas con toda la comunidad universitaria, ademas de crear un pequeño ingreso economico, tambien ayudas con el medio ambiente!
	</p>
</header>
<!--MISIONYVISION-->
